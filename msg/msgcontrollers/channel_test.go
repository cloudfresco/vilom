...
func TestShowChannel(t *testing.T) {
	...
	req, err := http.NewRequest("GET", "http://localhost:8000/v0.1/channels/44b2e674-7031-4487-be96-60093bfe8ac3", nil)
	if err != nil {
		t.Error(err)
		return
	}
...
func TestGetChannelByName(t *testing.T) {
	...
	data := []byte(`{"channel_name" : "Floptical Question"}`)
	req, err := http.NewRequest("POST", "http://localhost:8000/v0.1/channels/channelbyname", bytes.NewBuffer(data))
...
func TestUpdateChannel(t *testing.T) {
	...
	data := []byte(`{"channel_name" : "channel2", "channel_desc" : "channel2 description"}`)

	req, err := http.NewRequest("PUT", "http://localhost:8000/v0.1/channels/44b2e674-7031-4487-be96-60093bfe8ac3", bytes.NewBuffer(data))
...
func TestDeleteChannel(t *testing.T) {
	...
	req, err := http.NewRequest("DELETE", "http://localhost:8000/v0.1/channels/44b2e674-7031-4487-be96-60093bfe8ac3", nil)
